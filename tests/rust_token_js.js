...
describe('rust_token_js', () => {
  ...
  const program = anchor.workspace.RustTokenJs; // CamelCase
  ...
  it("Mints a token", async () => {
    await program.rpc.proxyMint(new anchor.BN(1000), {
      accounts: {
  ...
  it("Set new mint authority", async () => {
    ...
    await program.rpc.proxyAuthoritySet(
      { mintTokens: {} },
